---
description: "Legacy alias for /clone:cancel-loop"
...
# Legacy Cancel Clone Loop Alias

`/clone:cancel-loop` is the preferred command. To cancel the active Clone Loop:
